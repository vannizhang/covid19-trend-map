            ...
            return(
                <div
                    ...
                    style={{
                        ...
                        display: 'flex',
                        alignItems: 'center',
                        borderBottom: isActive ? `4px solid ${ThemeStyle["theme-color-red"]}` : `4px solid transparent`
                    }}
                >{icon}</div>
            )
        });
