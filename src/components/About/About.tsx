        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    <p>These counts are sourced from the Johns Hopkins University CSSE feature service of daily <a target='_blank' href="https://www.arcgis.com/home/item.html?id=4cb598ae041348fb92270f102a6783cb">US County Cases</a> since February 22, 2020, and normalized into population-normalized rates using the population attribute also provided in the JHU service. Care has been taken to note, via county tooltip, when state reporting structures have impeded the Johns Hopkins University effort to aggregate this data in an ongoing fashion. Please refer to their <a target='_blank' href="https://coronavirus.jhu.edu/us-map-faq">frequently asked questions</a> for more context around this data. The Khaki basemap is <a target='_blank' href="https://livingatlas.arcgis.com/en/browse/#d=2&amp;q=khaki">available via Living Atlas</a>. Learn more about sparklines as a data visualization tool <a target='_blank' href="https://www.edwardtufte.com/bboard/q-and-a-fetch-msg?msg_id=000AIr">here</a>.</p>
                </div>
