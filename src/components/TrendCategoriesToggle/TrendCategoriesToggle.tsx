...
import { isStateLayerVisilbeSelector } from '../../store/reducers/Map';
...
const LegendData: {
    ...
    },
    {
        value: 'Spreading',
        tooltip:
            'Early stages, and, depending on an administrative area’s capacity, a manageable rate of spread',
        color: '#A5336E',
    },
    {
        value: 'Epidemic',
            ...
            return (
                ...
                >
                    <span className="avenir-demi">
                        Trend categories are available at the county level.
                        Please zoom in.
                    </span>
                </div>
            );
